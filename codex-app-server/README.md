...
sbx_codex() {
    ...
    local path="${2:-.}"
    local kit="docker.io/docker/sbx-kit-codex-app-server:latest"
...
```console
sbx create --kit "docker.io/docker/sbx-kit-codex-app-server:latest" --name myproject codex ~/myproject
